...
Файлы terraform (без ключей) находятся в папке [virt-homeworks/07-terraform-03-basic](https://github.com/Roma-EDU/devops-netology/tree/master/virt-homeworks/07-terraform-03-basic)
